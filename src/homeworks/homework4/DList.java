...
public class DList {
    ...
    public void insertAfter(Object item, DListNode node) {
        // Your solution here.
        if (node.item != null) {
            DListNode insAfterNode = newNode(item, node, node.next);
            node.next.prev = insAfterNode;
            node.next = insAfterNode;
            size++;
        }
    }
    ...
    public void insertBefore(Object item, DListNode node) {
        // Your solution here.
        if (node.item != null) {
            DListNode insBeforeNode = newNode(item, node.prev, node);
            node.prev.next = insBeforeNode;
            node.prev = insBeforeNode;
            size++;
        }
    }
