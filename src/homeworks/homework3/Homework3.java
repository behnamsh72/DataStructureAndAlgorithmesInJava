package homeworks.homework3;/* Homework3.java */
...
public class Homework3 {
    ...
    public static void smoosh(int[] ints) {
        ...
        int inedx = 0;
        int i = 0;
        int decreaseLength = ints.length;
        while (i < decreaseLength - 1) {
            if (ints[i] == ints[i + 1]) {
                inedx = i;
                while (inedx < ints.length) {
                    if (inedx == ints.length - 1) {
                        ints[inedx] = -1;
                        decreaseLength--;
                        inedx++;
                    } else {
                        ints[inedx] = ints[inedx + 1];
                        inedx++;
                    }
                }
  ...
  /*              System.out.println(i);
                ...
                System.out.println();
                System.out.println("Decrease length:"+decreaseLength);*/
            }
        }
    }
